...
import requests , logging , time , win32com.client , os , zipfile , xlrd , pymysql
...
if __name__ == '__main__':
    ...
    # check taipei invoice email errors from government cloud platform
    check_taipei_invoice_email = invoice_check()
